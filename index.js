 ...
 function add_light_house(pos_x,pos_y,pos_z)
{
    ...
    const cylinder = new Reflector( geometry, {clipBias: 0.003,textureWidth: window.innerWidth * window.devicePixelRatio,	textureHeight: window.innerHeight * window.devicePixelRatio,color: 0x777777	} );
    ...
    // const cylinder1 = new Reflector( geometry, {clipBias: 0.003,textureWidth: window.innerWidth * window.devicePixelRatio,	textureHeight: window.innerHeight * window.devicePixelRatio,color: 0x777777	} );
 ...
 function add_street_light(pos_x,pos_y,pos_z)
{
    ...
    loader.load('/resources/lamp/street_lamp.obj',  function (object) {
 ...
 function check_collision()
{
    ...
    if(stuck!=-1)
    {
        ...
        {
            let car = car_f;
            // characters[1].root.position.x = car[stuck].position.x;
            
            // for (let i=0;i<characters.length;i++)
            {
                characters.root.position.x = car[stuck].position.x;
                
            }
            characters.root.position.z = car[stuck].position.z-60;
            // characters[1].root.position.z = car[stuck].position.z;
            // characters[2].root.position.z = car[stuck].position.z+60;
        }
        if(stuck_type=='r')
        {
            let car = car_r;
 ...
 function render()
{
    ...
    for ( let i=0; i<morphs.length; i++ )
    {
        ...
        // if ( morph.position.x > 5e3)
        // {
        //     morph.position.x = - 5e3;
        // }
    }
    check_collision();
    renderer.clear();
